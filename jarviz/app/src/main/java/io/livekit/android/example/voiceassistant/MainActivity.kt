                    ...
                    Box(modifier = Modifier.padding(innerPadding)) {
                        ...
                        NavHost(navController, startDestination = ConnectRoute) {
                            ...
                            composable<ConnectRoute> {
                                ConnectScreen { _, _ ->
                                    val url = "wss://jarvis-10-0938vxk6.livekit.cloud"
                                    val token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NTkxMzg2MjIsImlkZW50aXR5IjoidGVzdF91c2VyIiwiaXNzIjoiQVBJd1huN0t5V3M3VXl0IiwibmFtZSI6InRlc3RfdXNlciIsIm5iZiI6MTc1OTA1MjIyMiwic3ViIjoidGVzdF91c2VyIiwidmlkZW8iOnsicm9vbSI6InRlc3Rfcm9vbSIsInJvb21Kb2luIjp0cnVlfX0.pikJrwgIK-a9OfSENssL_nlbrIPig6XHMFH84QxZL84"
                                    runOnUiThread {
